...
public sealed class AsyncDelegateInThrowsConstraintAnalyzer : DiagnosticAnalyzer
{
    ...
    private static readonly DiagnosticDescriptor Rule = new(
        ...
        messageFormat:
        "Async delegates are not supported as the actual value of '{0}': the Editor freezes or the assertion fails. Test the exception with try/catch in an async test method instead.",
        category: "Assertion",
        ...
        helpLinkUri: "https://github.com/nowsprinting/test-framework.analyzers/tree/master/Documentation~/rules/UTF2002.md");
