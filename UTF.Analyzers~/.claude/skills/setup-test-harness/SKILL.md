...
```xml
<PropertyGroup>
    <!-- The verifier compiles with the Roslyn version brought in by the ProjectReference (4.3.0), whose default is C# 10.
         Pin the Tests project to the same level; otherwise a fixture using newer syntax builds here and fails in the verifier -->
